...
export class MinusrusPage {
    ...
    private ruBtn: By = By.xpath('//a[@href="/ru"]')
    ...
    private cards: By = By.xpath('//div[@class="card"]')
    private dailyAmount: By = By.xpath('//span[@class="card__amount-total"]')
    ...
    public async chooseDate(expectedDate: string): Promise<void> {
        ...
        // const formatedCurrentDate: Date = await this.changeStringToDATE(expectedDate)
        // const formatedExpectedDate: Date = await this.changeStringToDATE(currentDate)
        // const formatedString = this.changeStringToDATE(expectedDate)
        // const formatedStringW = this.changeStringToDATE(currentDate)

        const splitedDate =  currentDate.split('.')
        const reverrsedDate = splitedDate.reverse()
        const formatedString = reverrsedDate.join('.')

        const splitedDatew =  expectedDate.split('.')
        const reverrsedDatew = splitedDatew.reverse()
        const formatedStringw = reverrsedDatew.join('.')

        const formatedCurrentDate = new Date(formatedString)
        const formatedExpectedDate = new Date(formatedStringw)
    ...
    public async testTaskSwitcher(entity: string) {
        ...
        let cardElement: WebElement

        for(cardElement of cardsElements){
