...
export class MinusrusPage {
    ...
    public async changeDate(expectedDate: string): Promise<void> {
        ...
        // await this.dateSwitcher(currentDate, expectedDate, leftArrow)
    ...
    private async dateSwitcher(currentDate: string, expectedDate: string, leftArrow: WebElement): Promise<void> {
        // while(currentDate !== expectedDate){
        //     leftArrow.click()
        //     logger.info(currentDate)
        //     logger.info(expectedDate)
