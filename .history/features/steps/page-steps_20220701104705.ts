...
Given('I open American Eagle',{timeout: 100 * 1000}, async function(){
    logger.info('Open an American Eagle');
...
When('I choose a category', {timeout: 100 * 1000}, async function (){
    ...
    logger.info('I choose a category')
