...
Given('test_1{num}{num2}',{timeout: 100 * 1000}, async function(num: number = 2, num2:number = 3){
    this.result = this.calculator.sum(num, num2)
});

Given('test_2 {int}',{timeout: 100 * 1000}, async function(int: number = 5){
