...
export class CheckoutPage {
    ...
    private stateItem: By = By.xpath('.//select[@name="states"]/option[41]');
    ...
    public async fillingInAdress(): Promise<void> {
        ...
        await street.sendKeys('4851 Dasia Village Suite 753');
        await delay(2000);
        ...
        await city.sendKeys('Lemkeshire');
        await delay(2000);
    ...
    public async checkingProblem() {
        ...
        await errorEmail.getText() === 'Please enter credit card number, this field can/t be empty';
    }
}