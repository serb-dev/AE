...
export class CheckoutPage {
    ...
    private cardTermError: By = By.xpath('.//div[@data-label-code="error.checkout.payment.expirationDate.emptyerror.checkout.payment.expirationDate.empty"]');
    private cvvError: By
    ...
    public async checkingProblem() {
        ...
        && errorNumber.concat('Please enter credit card number, this field can/t be empty')){
            console.log('done')
        }
        else{
